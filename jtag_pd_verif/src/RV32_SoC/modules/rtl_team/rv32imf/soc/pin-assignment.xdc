...
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { tck_i }]; # TX   IO_L21N_T3_DQS_A18_15 Sch=ja[2]


set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { tdi_i }]; # RX   IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { tms_i }]; # CTS   IO_L21P_T3_DQS_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { tdo_o }]; # RTS   IO_L18N_T2_A23_15 Sch=ja[4]
...
create_clock -period 100.000 -name tck_clk_pin [get_ports tck_i]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets tck_i_IBUF]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { tck_i }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
