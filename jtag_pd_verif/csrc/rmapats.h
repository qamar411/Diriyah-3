...
typedef struct {
    ...
    U  I1084;
    U  I1085;
    HsimSignalMonitor  * I1086;
    HsimPostNbaClkMonitor  * I1087;
    RP  I1088;
    RmaTimeStamp64  I649;
    U  I1089;
    RmaTimeStamp64  I1090;
    U  I1091;
    UB  I1092 :1;
    UB  I1093 :1;
    UB  I1094 :1;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    RmaSeqPrimOutputOnClkOpt  I1239;
    RmaSeqPrimOutputEblkData  I1244;
...
struct dummyq_struct {
    ...
    struct futq * I1360;
    struct futq * I1361;
    struct sched_table * I1362;
    struct futq_info * I1364;
    struct futq_info * I1366;
    U  I1367;
    U  I1368;
    U  I1369;
    U  I1370;
...
void  rmaPropagate7_p_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate7_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
...
void  rmaPropagate11_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
...
void  rmaPropagate26_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate27_p_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate27_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate27_lbs_simv_daidir (UB  * pcode, scalar  val, U  I1160);
void  rmaPropagate27_lps_simv_daidir (UB  * pcode, vec32  * I1547, U  I1160, U  I1557);
void  rmaPropagate27_s0f_simv_daidir (UB  * pcode, vec32  * I1130);
void  rmaPropagate28_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate29_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate30_p_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate30_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate30_t0_simv_daidir (UB  * pcode, U  I1002);
void  rmaPropagate31_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate32_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate33_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate34_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate35_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate36_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate37_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate38_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate39_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate40_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate41_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
...
void  rmaPropagate46_p_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate46_simv_daidir (UB  * pcode, vec32  * I1130, U  I1002);
void  rmaPropagate46_t0_simv_daidir (UB  * pcode, U  I1002);
